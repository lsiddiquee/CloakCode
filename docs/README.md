...
2. [02 — Research findings](02-research-findings.md) — the empirical heart: API investigation, on-disk storage map, every experiment and its verdict, the capability matrix.
